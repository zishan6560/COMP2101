...
#Here i am creating two trap signal. First one is Reset that perfom INT signal and second one forceExit that perform QUIT
...
function forceExit
{
	echo "Ohh!! you got secret exit. You are getting out immediately"
	exit
}
function reset
{
	echo "Sorry!! You are not allowed to interrupt."
